...
@section('content')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 bg-white rounded-lg shadow-xl" >
            <form action={{ route('register') }} method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Repite tu password" class="border  p-3 w-full rounded-lg @error('password') border-red-500 @enderror">
                </div>
